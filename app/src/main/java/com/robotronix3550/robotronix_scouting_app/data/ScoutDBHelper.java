...
public class ScoutDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_SCOUTS_TABLE =  "CREATE TABLE " + ScoutEntry.TABLE_NAME + " ("
                ...
                + ScoutEntry.COLUMN_SCOUT_SAND_HAB_LVL2 + " INTEGER NOT NULL DEFAULT 0, "
                + ScoutEntry.COLUMN_SCOUT_SAND_HAB_LVL3 + " INTEGER NOT NULL DEFAULT 0, "
                ...
                + ScoutEntry.COLUMN_SCOUT_TELE_HAB_LVL2 + " INTEGER NOT NULL DEFAULT 0, "
                + ScoutEntry.COLUMN_SCOUT_TELE_HAB_LVL3 + " INTEGER NOT NULL DEFAULT 0, "
                ...
                + ScoutEntry.COLUMN_SCOUT_MATCH_TIE + "INTEGER NOT NULL DEAFAULT 0 ) ;";
